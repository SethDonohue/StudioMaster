...
function TextInput(field){
    const className = `form__control form__control--large ${field.meta.touched && field.meta.error ? "form__control--warning" : ""} ${field.success && !field.meta.error && field.meta.touched ? 'form__control--success' : ''}`;
